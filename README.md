...
| :--- | :--- | :--- |
| **PlotFinder** | Structure | Project, Chapter, & Beat orchestration. |
| **Writer** | Creation | Human-AI Hybrid (Regie-Modus). |
| **Editor** | Quality | AI-powered developmental editing & proofreading. |
...
HighCoo-Writer isn't just a frontend for LLMs; it's a distributed system designed for **resilience, scalability, and context-awareness**.

### 🏛️ Architecture: DDD-Driven Microservices
The system is built on **Domain-Driven Design (DDD)** principles, ensuring that complex business logic (e.g., Plot Orchestration vs. Narrative Generation) remains decoupled.
...
* **Regie-Modus Engine:** Serverless Functions / Service Workers aggregate real-time metadata from various DDD aggregates to inject "mental state" into LLM prompts.
